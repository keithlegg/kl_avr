...
//THIS IS CHANGED TO PORTF ON MEGA!
//IT IS CTRL_PORT ON UNO

#define TFT_DC 0x01      //  AVR_PB0  // SEEMS TO PULSE EVERY 4 OR SO BYTES - 32bit? 
#define TFT_CS 0x02      //  AVR_PB2  // SPI SS/CS 

// DONT THINK WE NEED THIS?
#define TFT_RST 0x04     //  AVR_PB1 
 // DONT THINK WE NEED THIS?

#define CTRL_PORT PORTF // USE THIS PORT FOR SOFTWARE CONTROLED SPI CS LINES
